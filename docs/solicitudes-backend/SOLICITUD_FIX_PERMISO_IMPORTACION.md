# Solicitud BE: Fix permiso IMPORTACION_DATOS para SUPER_ADMIN/SOPORTE
...
## Solicitud
Crear una migración `fix_permiso_importacion_superadmin` (versión la define el backend):
