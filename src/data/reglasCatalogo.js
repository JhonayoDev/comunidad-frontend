export const REGLAS_CATALOGO = [
  { tipo: "VISITA_PREAUTORIZADA", audiencia: "GUARDIAS_EN_TURNO", canales: ["IN_APP"], prioridad: "ALTA", esObligatoria: true },
  { tipo: "VISITA_INGRESADA", audiencia: "UNIDAD", canales: ["IN_APP", "PUSH"], prioridad: "ALTA", esObligatoria: false },
  { tipo: "VISITA_RECHAZADA", audiencia: "UNIDAD", canales: ["IN_APP"], prioridad: "NORMAL", esObligatoria: false },
  { tipo: "ENCOMIENDA_RECIBIDA", audiencia: "UNIDAD_OCUPANTES", canales: ["IN_APP", "EMAIL", "PUSH"], prioridad: "NORMAL", esObligatoria: true },
  ...
  { tipo: "RESERVA_CREADA", audiencia: "ADMINISTRADORES", canales: ["IN_APP", "EMAIL"], prioridad: "NORMAL", esObligatoria: false },
